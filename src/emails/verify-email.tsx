        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-full max-w-[465px]">
            ...
            <Section className="text-center mt-[32px] mb-[32px]">
              <Text className="text-black font-medium text-base leading-[24px] mb-8">
                Click the following link to verify your email
              </Text>

              <Text className="text-black font-medium text-base leading-[24px]">
                <Link
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px] flex items-center justify-center">
              © 2024 {env.APPLICATION_NAME}. All rights reserved.
            </Text>
          </Container>
        </Body>
      </Tailwind>
